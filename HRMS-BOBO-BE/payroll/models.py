...
class Payroll(models.Model):
    ...
    # new_fixed_salary = models.FloatField(default=0)
    # new_statutory_bonus = models.FloatField(default=0)
    # new_pf_emr = models.FloatField(default=0)
    # new_pf_emp = models.FloatField(default=0)
    # new_total_gross_salary = models.FloatField(default=0)
